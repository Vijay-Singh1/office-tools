...
import {
  Box, MuiDrawer, MuiAppBar, Toolbar, List, CssBaseline, Typography, Divider, IconButton,
...
import {
  ...
  Inbox as InboxIcon, Mail as MailIcon, ExpandLess, ExpandMore,
            ...
            <>
              ...
              <Collapse in={nestedOpen[index]} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  {['Sub-item 1', 'Sub-item 2'].map((subtext) => (
