...
const Appbar = () => {
  return (
    <Box sx={{ flexGrow: 1 }} height={"60px"} position="sticky">
    <AppBar position='static' >
        ...
        <Typography variant='subtitle1' sx={{display : {sm : "block", xs : "none"}}}>OFFICE TOOLS</Typography>
            ...
            <NavItems>
            <StyledNavLink to="/"><Typography variant='subtitle1'>HOME</Typography> </StyledNavLink>
            <StyledNavLink to="/form-builder"><Typography variant='subtitle1'>FORMS</Typography></StyledNavLink>
            <StyledNavLink to="/image-editor"><Typography variant='subtitle1'>IMAGEEDITOR</Typography></StyledNavLink>
